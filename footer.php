...
<footer id="colophon" class="footer items-center p-4 bg-neutral text-neutral-content" role="contentinfo">
	...
	<div class="container max-w-[1280px] mx-auto">
		<div class="items-center grid-flow-col">
			...
			<p>&copy; <?php echo date_i18n( 'Y' ); ?> - <?php echo get_bloginfo( 'name' ); ?></p>
		</div>
